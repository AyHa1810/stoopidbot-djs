...
/** Horrible attempt to create a time to milliseconds converter, instead use the ts package "ms" :P
...
module.exports = { getSettings, permlevel, awaitReply, toProperCase, msConvert, getFiles, getSubDir, timer, getUserFromMention };